...
meta_default_path = scars_root + "/cars_{}.mat"
...
def get_scars_datasets(
    ...
    whole_training_set = CarsDataset(
        data_dir=car_root,
    ...
    print(
        "Lens: train_labelled: {}, train_unlabelled: {}, val: {}, test: {}, test_seen: {}".format(
            len(train_dataset_labelled),
            len(train_dataset_unlabelled),
            len(val_dataset_labelled) if split_train_val else 0,
            len(test_dataset),
            len(test_dataset_seen),
        )
    )
    all_datasets = {
...
if __name__ == "__main__":
    x = get_scars_datasets(
        None,
        None,
        train_classes=range(98),
